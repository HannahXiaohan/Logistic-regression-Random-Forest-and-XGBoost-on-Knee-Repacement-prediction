...
Fit the Randaom Forest and XGBoost models with the OAI dataset. Comparing the metrics( AUC, Accuracy, precision, recall, specificity, F1 score, and Brier score), Random Forest is indicated as a better model for the OAI dataset to predict the future knee replacement.
